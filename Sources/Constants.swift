...
private let translations: [Lang: [String: String]] = [
    .fr: [
        ...
        "menu_chatters_error": "Liste indisponible pour cette chaîne",
    ...
    .en: [
        ...
        "menu_chatters_error": "List unavailable for this channel",
    ...
    .es: [
        ...
        "menu_chatters_error": "Lista no disponible para este canal",
