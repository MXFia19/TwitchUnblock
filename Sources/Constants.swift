...
private let translations: [Lang: [String: String]] = [
    .fr: [
        ...
        "fill_screen_sub": "Recadre la vidéo pour supprimer les bandes noires. Coupe le haut et le bas de l'image.",
    ...
    .en: [
        ...
        "fill_screen_sub": "Crops the video to remove black bars. Cuts off the top and bottom of the picture.",
    ...
    .es: [
        ...
        "fill_screen_sub": "Recorta el vídeo para quitar las franjas negras. Corta la parte superior e inferior de la imagen.",
